...
const ContactPage = () => {
  ...
  const openWhatsApp = () => {
    ...
    window.open(`https://wa.me/919894500868?text=${encodeURIComponent(msg)}`, "_blank");
  };
    ...
    <main className="min-h-screen bg-white pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            <h4 className="text-[#F37021] font-black uppercase tracking-[0.3em] text-xs mb-4">Get In Touch</h4>
          ...
          <div className="space-y-6">
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 flex flex-col gap-4">
                ...
                <div>
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Call Anytime</p>
                  <p className="text-lg font-black text-[#1A1A1B]">+91 98945 00868</p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-black text-[#1A1A1B]">hello@blackantz.in</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-10 rounded-[3rem] bg-[#1A1A1B] text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 mb-4">Follow Our Creative Journey</h4>
                <div className="flex gap-4">
                  {[FaInstagram, FaFacebookF].map((Icon, i) => (
                    <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#F37021] hover:border-[#F37021] transition-all">
                      <Icon size={16} />
                    </a>
                  ))}
                </div>
            ...
            >
              <FaWhatsapp size={24} />
              <span className="font-black uppercase tracking-widest text-sm group-hover:scale-105 transition-transform">Quick Chat on WhatsApp</span>
            </button>
          </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-2">Your Name</label>
                  <input 
                    type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-2">Select Service</label>
                <select 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-2">Project Brief</label>
                <textarea 
                  rows={4} 
