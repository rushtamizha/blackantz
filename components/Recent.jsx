...
const allWorks = [
    {
      ...
      image: "/RECENT WORKS/ACP Acrylic Sign.jpg",
    ...
    },
    {
      ...
      image: "/RECENT WORKS/Acrylic Sign.jpg",
    ...
    },
    {
      ...
      image: "/RECENT WORKS/alu_Siv.jpg",
    ...
    },
    {
     ...
     image: "/RECENT WORKS/Arizo_Ricebran Oil Pouch.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/FABRIC BOARD.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/FRONT SIGN.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/LED SLIM BOARD.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/PACK.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/Packaging - all.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/Picle 002.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/POSTER DESIGN.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/Restaurant poster6.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    },
    {
      title: "Package Design & Events",
      description: "From product packaging to high-impact event stalls and backdrops.",
     image: "/RECENT WORKS/SUPER.jpg",
      items: ["Carton Boxes", "Product Packaging", "Container Wrapping", "Event Backdrops", "Stall Creatives", "Rollup Standees"]
    }
];
            ...
            <SwiperSlide key={`${work.id}-${idx}`}>
              <div className="relative group aspect-[4/4] rounded-[2rem] overflow-hidden bg-gray-100 border border-gray-50 shadow-sm">
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                  <span className="text-[#F37021] text-[9px] font-black hidden uppercase tracking-[0.2em] mb-2 block">
                    {work.category}
                  </span>
                  <h3 className="text-white text-lg font-bold leading-tight uppercase mb-4 hidden">
                    {work.title}
                  </h3>
